...
import { createMobileWorkspaceFeatureRoutes } from './mobileWorkspaceRoutes';
...
const workspaceMobileRootChildren: RouteObject[] = [
  ...
  ...createMobileWorkspaceFeatureRoutes({
    includeDeveloper: false,
    labelPrefix: 'Mobile > Workspace',
  }),
];
    ...
    children: [
      ...
      // Settings routes (personal-only — never mirrored under /:workspaceSlug)
      {
        children: [
          ...
          {
            element: dynamicElement(
              () => import('@/routes/(mobile)/settings/[tab]'),
              'Mobile > Settings > Tab',
            ),
            path: ':tab',
          },
