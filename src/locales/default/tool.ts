export default {
  ...
  'agentMarketplace.inspector.moreCategories': '+{{count}} categories',
  'agentMarketplace.inspector.pickCount': '{{count}} selected',
  'agentMarketplace.render.alreadyInLibrary': '{{count}} already in library',
