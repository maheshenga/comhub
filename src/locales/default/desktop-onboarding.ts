export default {
  ...
  'screen5.actions.signInCloud': 'Sign in to {{brandName}}',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your {{brandName}} account to sync everything seamlessly',
  'screen5.methods.cloud.name': '{{brandName}}',
  'screen5.methods.selfhost.description': 'Connect to your own {{brandName}} server instance',
