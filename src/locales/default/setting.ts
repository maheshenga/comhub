export default {
  ...
  'about.title': 'About',
  'admin.branding.brandLogoUrl': 'Brand Logo URL',
  'admin.branding.brandName': 'Brand Name',
  'admin.branding.title': 'Branding',
  'admin.loadError': 'Failed to load site configuration',
  'admin.other.customFooter': 'Custom Footer',
  'admin.other.customFooterPlaceholder': 'HTML or text for the footer area',
  'admin.other.supportEmail': 'Support Email',
  'admin.other.title': 'Other',
  'admin.save': 'Save',
  'admin.saveError': 'Failed to save site configuration',
  'admin.saveSuccess': 'Site configuration saved successfully',
  'admin.site.officialUrl': 'Official URL',
  'admin.site.siteDescription': 'Site Description',
  'admin.site.siteDescriptionPlaceholder': 'A brief description of the site',
  'admin.site.siteTitle': 'Site Title',
  'admin.site.siteTitlePlaceholder': 'Displayed in browser tab and page title',
  'admin.site.title': 'Site Information',
  'admin.title': 'Admin Settings',
  'adminVip.title': 'VIP Management',
  'adminVip.plans.title': 'Plans',
  'adminVip.plans.name': 'Plan Name',
  'adminVip.plans.id': 'Plan ID',
  'adminVip.plans.priceMonthly': 'Monthly Price',
  'adminVip.plans.priceYearly': 'Yearly Price',
  'adminVip.plans.creditsPerMonth': 'Credits/Month',
  'adminVip.plans.enabled': 'Enabled',
  'adminVip.plans.sort': 'Sort Order',
  'adminVip.plans.description': 'Description',
  'adminVip.plans.features': 'Features (JSON)',
  'adminVip.plans.create': 'Create Plan',
  'adminVip.plans.edit': 'Edit',
  'adminVip.plans.delete': 'Delete',
  'adminVip.plans.deleteConfirm': 'Are you sure you want to delete this plan?',
  'adminVip.plans.createSuccess': 'Plan created successfully',
  'adminVip.plans.updateSuccess': 'Plan updated successfully',
  'adminVip.plans.deleteSuccess': 'Plan deleted successfully',
  'adminVip.redeem.title': 'Redeem Codes',
  'adminVip.redeem.code': 'Code',
  'adminVip.redeem.creditsAmount': 'Credits Amount',
  'adminVip.redeem.planId': 'Plan ID (optional)',
  'adminVip.redeem.planDurationDays': 'Plan Duration (days)',
  'adminVip.redeem.maxUses': 'Max Uses',
  'adminVip.redeem.usedCount': 'Used',
  'adminVip.redeem.expiresAt': 'Expires At',
  'adminVip.redeem.create': 'Create Redeem Code',
  'adminVip.redeem.delete': 'Delete',
  'adminVip.redeem.deleteConfirm': 'Are you sure you want to delete this redeem code?',
  'adminVip.redeem.createSuccess': 'Redeem code created successfully',
  'adminVip.redeem.deleteSuccess': 'Redeem code deleted successfully',
  'adminVip.users.title': 'User Management',
  'adminVip.users.userId': 'User ID',
  'adminVip.users.adjustCredits': 'Adjust Credits',
  'adminVip.users.amount': 'Amount (positive to add, negative to deduct)',
  'adminVip.users.adjustDescription': 'Reason',
  'adminVip.users.adjustSuccess': 'Credits adjusted successfully',
  'adminVip.users.grantSubscription': 'Grant Subscription',
  'adminVip.users.planId': 'Plan',
  'adminVip.users.durationDays': 'Duration (days)',
  'adminVip.users.grantSuccess': 'Subscription granted successfully',
  'adminVip.loadError': 'Failed to load data',
  'adminVip.operationError': 'Operation failed',
  'adminVip.stats.title': 'Dashboard',
  'adminVip.stats.activeSubscriptions': 'Active Subscriptions',
  'adminVip.stats.expiringSoon': 'Expiring in 7 days',
  'adminVip.stats.totalBalance': 'Total Credits Balance',
  'adminVip.stats.monthlyGranted': 'Monthly Granted',
  'adminVip.stats.monthlyConsumed': 'Monthly Consumed',
  'adminVip.bulk.title': 'Bulk Operations',
  'adminVip.bulk.userIds': 'User IDs (one per line)',
  'adminVip.bulk.adjustCredits': 'Bulk Adjust Credits',
  'adminVip.bulk.grantSubscription': 'Bulk Grant Subscription',
  'adminVip.bulk.amount': 'Amount',
  'adminVip.bulk.description': 'Reason',
  'adminVip.bulk.planId': 'Plan',
  'adminVip.bulk.durationDays': 'Duration (days)',
  'adminVip.bulk.success': 'Completed: {{success}}/{{total}}',
  'adminVip.export.title': 'Export Transactions',
  'adminVip.export.download': 'Download CSV',
  'adminVip.export.userId': 'Filter by User ID (optional)',
  'adminVip.export.type': 'Filter by Type (optional)',
  'adminVip.audit.title': 'Audit Logs',
  'adminVip.audit.actor': 'Actor',
  'adminVip.audit.action': 'Action',
  'adminVip.audit.target': 'Target',
  'adminVip.audit.time': 'Time',
  'adminVip.audit.details': 'Details',
  'adminVip.gateway.title': 'Gateway Config',
  'adminVip.gateway.description': 'Configure the NewAPI gateway for VIP model routing. Values saved here take priority over environment variables.',
  'adminVip.gateway.baseUrl': 'NewAPI Base URL',
  'adminVip.gateway.baseUrlPlaceholder': 'e.g. http://ai.hezebuy.cn/v1',
  'adminVip.gateway.apiKey': 'NewAPI API Key',
  'adminVip.gateway.apiKeyPlaceholder': 'sk-...',
  'adminVip.gateway.modelPricing': 'Model Pricing (JSON)',
  'adminVip.gateway.modelPricingPlaceholder': '{"gpt-4o": {"input": 2.5, "output": 10}}',
  'adminVip.gateway.modelPricingHelp': 'Credits per million tokens. Format: { "model-name": { "input": N, "output": N } }',
  'adminVip.gateway.cronSecret': 'Cron Secret',
  'adminVip.gateway.cronSecretHelp': 'Bearer token for /api/vip/cron endpoint authentication',
  'adminVip.gateway.save': 'Save Gateway Config',
  'adminVip.gateway.saveSuccess': 'Gateway configuration saved successfully',
  'adminVip.gateway.saveError': 'Failed to save gateway configuration',
  'adminVip.gateway.testConnection': 'Test Connection',
  'adminVip.gateway.testSuccess': 'Connection successful',
  'adminVip.gateway.testError': 'Connection failed',
  'adminVip.gateway.envFallback': 'Currently using environment variable',
  'tab.adminVip': 'VIP Management',
  'tab.vip': 'VIP',
  'vip.title': 'VIP Center',
  'vip.subscription.title': 'Current Subscription',
  'vip.subscription.plan': 'Plan',
  'vip.subscription.status': 'Status',
  'vip.subscription.expiresAt': 'Expires',
  'vip.subscription.none': 'No active subscription',
  'vip.subscription.active': 'Active',
  'vip.subscription.expired': 'Expired',
  'vip.subscription.expiredWarning': 'Your subscription has expired. Please renew to continue using VIP model services.',
  'vip.subscription.expiringTomorrow': 'Your subscription expires tomorrow! Please renew as soon as possible to avoid service interruption.',
  'vip.subscription.expiringSoon': 'Your subscription expires in {{days}} days. Please renew in time to ensure uninterrupted service.',
  'vip.subscription.expiringWeek': 'Your subscription expires in {{days}} days. Consider renewing soon.',
  'vip.credits.title': 'Credits',
  'vip.credits.balance': 'Current Balance',
  'vip.credits.totalEarned': 'Total Earned',
  'vip.credits.totalConsumed': 'Total Consumed',
  'vip.redeem.title': 'Redeem Code',
  'vip.redeem.placeholder': 'Enter redeem code',
  'vip.redeem.submit': 'Redeem',
  'vip.redeem.success': 'Redeemed successfully!',
  'vip.redeem.error.REDEEM_CODE_NOT_FOUND': 'Code not found',
  'vip.redeem.error.REDEEM_CODE_EXPIRED': 'Code has expired',
  'vip.redeem.error.REDEEM_CODE_MAX_USES_REACHED': 'Code has reached maximum uses',
  'vip.redeem.error.REDEEM_CODE_ALREADY_USED': 'You have already used this code',
  'vip.redeem.error.default': 'Redeem failed',
  'vip.transactions.title': 'Transaction History',
  'vip.transactions.type': 'Type',
  'vip.transactions.amount': 'Amount',
  'vip.transactions.description': 'Description',
  'vip.transactions.date': 'Date',
  'vip.transactions.empty': 'No transactions yet',
  'vip.transactions.type.subscription_grant': 'Subscription Grant',
  'vip.transactions.type.usage_deduct': 'Usage Deduction',
  'vip.transactions.type.redeem': 'Redeem',
  'vip.transactions.type.admin_adjust': 'Admin Adjustment',
  'vip.transactions.type.referral': 'Referral',
  'vip.plans.title': 'Available Plans',
  'vip.plans.creditsPerMonth': '{{count}} credits/month',
  'vip.plans.priceMonthly': '{{price}}/month',
  'vip.plans.priceYearly': '{{price}}/year',
  'vip.redeem.error.RATE_LIMITED': 'Too many attempts, please try again later',
  'vip.usage.title': 'Usage Statistics',
  'vip.usage.dailyTitle': 'Daily Usage (Last 30 Days)',
  'vip.usage.modelTitle': 'Usage by Model',
  'vip.usage.date': 'Date',
  'vip.usage.credits': 'Credits',
  'vip.usage.requests': 'Requests',
  'vip.usage.noData': 'No usage data yet',
  'vip.pricing.title': 'Model Pricing',
  'vip.pricing.inputRate': 'Input',
  'vip.pricing.outputRate': 'Output',
  'vip.pricing.perMillion': 'credits/M tokens',
