export default {
  ...
  'heteroAgent.cloudRepo.notSet': 'No repository',
  'heteroAgent.cloudRepo.noRepos': 'No repositories configured. Add them in agent settings.',
  'heteroAgent.cloudRepo.multiSelected': '{{count}} repositories',
  'hideForYou':
  ...
  'taskDetail.commentSubmitAndRun': 'Submit and run',
  ...
  'taskDetail.runAll.description':
    'Subtasks will run layer by layer. Each layer waits for the previous layer to finish. Tasks without dependencies run in layer 1.',
  ...
  'taskDetail.runAll.skipped.ineligible': '{{count}} tasks are running or scheduled - skipped',
  'taskDetail.runAll.skipped.blockedExternally':
    '{{count}} tasks are waiting on a blocker outside this batch - they will run after it clears',
  ...
  'taskDetail.runAll.empty':
    'Nothing to run - every subtask is already completed, running, or blocked by a cycle.',
  'taskDetail.runAll.confirm': 'Run {{count}} subtasks',
  'taskDetail.runAll.cancel': 'Cancel',
  'taskDetail.runAll.kickedOff': 'Started {{count}} subtasks; downstream layers will follow.',
  'taskDetail.runAll.partialFailure': 'Started {{ok}} of {{total}} subtasks; {{failed}} failed.',
  ...
  'thread.subagentReadOnlyHint': 'This is a read-only sub-agent thread.',
  ...
  'tool.intervention.rememberSimilar': 'Remember similar approvals',
  ...
  'workingPanel.resources.tree.createError': 'Create failed',
  'workingPanel.resources.tree.moveError': 'Move failed',
  ...
  'workingPanel.review.baseRef.unresolved': 'Choose a base branch',
  ...
  'workingPanel.review.empty.branch': 'No changes against {{baseRef}}',
  'workingPanel.review.empty.noBaseRef':
    'Could not determine the remote default branch. Run `git remote set-head origin --auto` in your terminal.',
