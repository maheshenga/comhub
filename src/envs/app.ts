...
export const getAppConfig = () => {
  return createEnv({
    ...
    server: {
      ...
      /**
       * Platform NewAPI Gateway for VIP users.
       * When set, VIP users without their own API keys will have requests
       * routed through this OpenAI-compatible gateway.
       */
      PLATFORM_NEWAPI_BASE_URL: z.string().optional(),
      PLATFORM_NEWAPI_API_KEY: z.string().optional(),
      PLATFORM_NEWAPI_MODEL_PRICING: z.string().optional(),
      /**
    ...
    runtimeEnv: {
      ...
      PLATFORM_NEWAPI_BASE_URL: process.env.PLATFORM_NEWAPI_BASE_URL,
      PLATFORM_NEWAPI_API_KEY: process.env.PLATFORM_NEWAPI_API_KEY,
      PLATFORM_NEWAPI_MODEL_PRICING: process.env.PLATFORM_NEWAPI_MODEL_PRICING,
