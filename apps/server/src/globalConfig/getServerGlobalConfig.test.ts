...
describe('getServerGlobalConfig', () => {
  ...
  it('should only pre-enable ComHub admin-managed NewAPI in business feature mode', async () => {
    ...
    expect(providerConfig[ModelProvider.DeepSeek].enabled).toBeUndefined();
