export default {
  ...
  'newapi.apiKey.desc': 'API key provided by your AI provider',
  'newapi.apiKey.placeholder': 'AI provider API Key',
  'newapi.apiKey.required': 'API key is required',
  'newapi.apiKey.title': 'API Key',
  'newapi.apiUrl.desc': 'API endpoint for the AI provider service, usually includes /v1',
  'newapi.apiUrl.title': 'API URL',
  'newapi.enabled.title': 'Enable AI Provider',
