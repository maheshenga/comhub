export default {
  ...
  "flow.steps.chiefAgent.personas.blueprint.intro": "I habitually think one step ahead and name the risks first.",
  "flow.steps.chiefAgent.personas.breeze.intro": "No fluff — straight to results. Reliable, just very casual about it.",
  "flow.steps.chiefAgent.personas.buttercup.intro": "Even the most ordinary day deserves to be taken seriously.",
  "flow.steps.chiefAgent.personas.byte.intro": "Clear logic is my baseline — even small talk stays sharp.",
  "flow.steps.chiefAgent.personas.coco.intro": "I can handle serious work — and make it a bit more fun along the way.",
  "flow.steps.chiefAgent.personas.dispatch.intro": "Anything you hand me, I follow through and keep you posted.",
  "flow.steps.chiefAgent.personas.flex.intro": "Whatever the goal, I'll push through it with you in one go.",
  "flow.steps.chiefAgent.personas.hexley.intro": "However complex the problem, I can give it a touch of stage magic.",
  "flow.steps.chiefAgent.personas.kernel.intro": "I like drilling into things all the way down — no detail escapes.",
  "flow.steps.chiefAgent.personas.latte.intro": "Take it slow — that's how things come out just right.",
  "flow.steps.chiefAgent.personas.lobe.intro": "Whatever the task, I'm happy to start from scratch with you.",
  "flow.steps.chiefAgent.personas.maestro.intro": "Whatever lands on my desk, I want to give it grace and rhythm.",
  "flow.steps.chiefAgent.personas.moss.intro": "Even urgent things don't rush me — I get them done right, steadily.",
  "flow.steps.chiefAgent.personas.riot.intro": "Whatever you want to say, I'll help you say it with more force.",
  "flow.steps.chiefAgent.personas.shutter.intro": "I notice the details others miss — usually first.",
  "flow.steps.chiefAgent.personas.sienna.intro": "I love turning any idea into something vivid and story-like.",
  "flow.steps.chiefAgent.title": "Meet your Chief Agent",
  "flow.steps.connectApps.apps.github.description": "We analyze your repos and contributions to understand your tech stack, skills, and work style",
  "flow.steps.connectApps.apps.gmail.description": "We read your emails to understand your communication style, key relationships, and recurring interests",
  "flow.steps.connectApps.apps.googleCalendar.description": "We scan your events and schedule to understand your priorities, routines, and time habits",
  "flow.steps.connectApps.apps.notion.description": "We explore your notes and pages to understand how you think, organize ideas, and manage projects",
  "flow.steps.connectApps.apps.twitter.description": "We review your posts and activity to understand your opinions, passions, and social connections",
  ...
  "flow.steps.learnYourWorld.analysisFailed": "We could not finish analyzing your connected sources.",
  ...
  "flow.steps.messenger.localAgents.note": "To link local agents, you'll need to download the desktop app first.",
  "flow.steps.messenger.localAgents.subtitle": "Link tools like Claude Code, Codex, and I'll help keep them all in line.",
  ...
  "flow.steps.profile.supplementModal.description": "Add extra context or links to help AI understand you better. You can change these later.",
  "flow.steps.profile.supplementModal.placeholder": "Describe yourself, your interests, work, or profile link...",
  ...
  "flow.steps.starterTasks.subline": "Assign clear tasks to your CAO, then track its progress as it completes each one.",
