export default {
  ...
  'settingSystemTools.detectFailed': 'Failed to detect system tools: {{error}}',
  'settingSystemTools.detecting': 'Detecting...',
  'settingSystemTools.installFailed': 'Failed to install {{name}}: {{error}}',
  'settingSystemTools.installOrRetry': 'Install / Retry',
  'settingSystemTools.installSuccess': '{{name}} installed',
  'settingSystemTools.installing': 'Installing...',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspaceSetting.auditLog.columns.action': 'Action',
  'workspaceSetting.auditLog.columns.actor': 'Actor',
  'workspaceSetting.auditLog.columns.createdAt': 'Time',
  'workspaceSetting.auditLog.columns.metadata': 'Metadata',
  'workspaceSetting.auditLog.columns.resource': 'Resource',
  'workspaceSetting.auditLog.desc':
    'Review recent workspace administration, membership, billing, and subscription changes.',
  'workspaceSetting.auditLog.empty': 'No audit log records yet.',
  'workspaceSetting.auditLog.filters.action': 'Action',
  'workspaceSetting.auditLog.filters.clear': 'Clear filters',
  'workspaceSetting.auditLog.filters.endDate': 'End date',
  'workspaceSetting.auditLog.filters.startDate': 'Start date',
  'workspaceSetting.auditLog.loadMore': 'Load more',
  'workspaceSetting.auditLog.loadError': 'Failed to load workspace audit logs.',
  'workspaceSetting.auditLog.noWorkspace': 'Open a workspace before viewing audit logs.',
  'workspaceSetting.auditLog.title': 'Audit Log',
  'workspaceSetting.group.admin': 'Admin',
  'workspaceSetting.group.agent': 'Agent',
  'workspaceSetting.group.general': 'General',
  'workspaceSetting.tab.auditLog': 'Audit Log',
