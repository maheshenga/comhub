export default {
  ...
  "resource.artifacts.overLimit": "Existing projects remain online. New projects are blocked until you unpublish one or upgrade.",
  ...
  "input.modelFixedTip": "The model is fixed in the Agent Profile and cannot be switched while chatting.",
