export default {
  ...
  'heteroAgent.claudeQuota.calendar.noLedgerSpendHint':
    "Token history is only recorded for runs started in ComHub after usage tracking was enabled. Earlier usage and runs started directly from the terminal cannot be backfilled.",
  ...
  'heteroAgent.codexQuota.errorConnection':
    "Couldn't reach the Codex quota endpoint. Check your network or ComHub proxy settings.",
  ...
  'heteroAgent.apiMode.agentUnsupported': "{{name}} does not support ComHub Provider binding.",
  ...
  'heteroAgent.apiMode.defaultProviderConfigMissing':
    "ComHub requires a compatible model. Open the agent profile to select one.",
  ...
  'codeBuddyInstallGuide.reason': "ComHub could not start CodeBuddy: {{message}}",
  ...
  'cursorInstallGuide.reason': "ComHub could not start Cursor: {{message}}",
  ...
  'droidInstallGuide.reason': "ComHub could not start Factory Droid: {{message}}",
  ...
  'grokBuildInstallGuide.reason': "ComHub could not start Grok Build: {{message}}",
  ...
  'piInstallGuide.reason': "ComHub could not start Pi: {{message}}",
  ...
  'qoderInstallGuide.reason': "ComHub could not start Qoder: {{message}}",
  ...
  'kimiCodeInstallGuide.reason': "ComHub could not start Kimi Code: {{message}}",
  ...
  'traeInstallGuide.reason': "ComHub could not start TRAE CLI: {{message}}",
  ...
  'taskList.unassignedAgentHint': "ComHub will run this task when no agent is selected",
  ...
  "permission.configAccess.agentRoleRestricted": 'Your workspace role cannot configure Agents. You were returned to chat.',
  "permission.configAccess.groupRoleRestricted": 'Your workspace role cannot configure Agent Groups. You were returned to chat.',
  ...
  "workingPanel.deployments.overLimit": 'Existing projects remain online. New projects are blocked until you unpublish one or upgrade.',
  ...
  "workingPanel.deployments.publishingUpdate": 'Publishing an update. v{{revision}} remains online.',
  ...
  "workingPanel.deployments.unpublishConfirm": 'Unpublish {{title}}? Its permanent URL will stop serving the current release.',
  ...
  "input.addAiPrefillUnsupported": 'The current model doesn’t support ending the conversation with an assistant message. Follow it with a user message before sending.',
  "connectAgent.create.title": 'Connect Agent',
  "connectAgent.create.stepDevice": 'Step 1 of 3 · Pick the machine your agents run on — it will be scanned automatically.',
  ...
  "connectAgent.create.noDevicesDesc": 'Connect a computer to discover and run the agents installed on it.',
  "connectAgent.create.noDevicesDesktopHint": 'Install the Desktop App — it connects automatically after login',
  ...
  "topicComment.deleteConfirm.content": 'This comment will be removed. Replies will remain if this starts a thread.',
  ...
  "topicComment.removedOwnerView": 'Removed by a Workspace Owner. This content is visible only to Workspace Owners during the recovery period.',
