...
- Runtime boundary: uploaded executable code is still not run. The capability SDK and core gateway are present, while the runtime service, iframe shell, production sandbox policy, and execution feature flag remain subsequent stages.
