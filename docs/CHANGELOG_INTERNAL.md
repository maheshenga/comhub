...
- Launch verification: 60 focused type/database/router/service/SDK/runtime/UI/router-sync tests, full `bun run type-check`, targeted ESLint, locale JSON parsing, and `git diff --check`.
