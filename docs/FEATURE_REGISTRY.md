...
- Frontend entries: `/apps`, `/apps/my`, `/apps/team`, `/apps/:appId`, `/apps/:appId/app`, `/apps/:appId/app/:pageKey`, and `/admin/module-apps` Commerce controls. The app detail page isolates personal/team catalog, order, license, and launch state by optional `workspaceId`; the runtime page displays the latest persisted cost snapshot.
